...
import io.practiceinsight.pinpayments.pojo.EventResult;

/**
 * Integration tests for {@link EventsApi} class.
 *
 * @author delight.wjk@gmail.com
 */
@Test(groups = "integration")
public class EventsApiIntegrationTest extends AbstractBaseTest {

  private EventsApi eventsApi;

  @BeforeMethod(groups = "integration")
  public final void setUp() throws Exception {
    eventsApi = inject(EventsApi.class);
  }
  ...
  public final void testFetch() throws Exception {
    // Given
    final EventListResponse list = eventsApi.list(1);
    final EventResult eventResult = list.response().get(0);

    // When
    final EventResponse fetched = eventsApi.fetch(eventResult.token());
